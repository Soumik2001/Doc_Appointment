  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button className={`py-1 px-3 text-sm boder rounded transition-all sm:hidden ${showFilter?"bg-primary text-white":""}`} onClick={()=>setShowFilter(prev=>!prev)}>Filters</button>
          ...
          {filterDoc.map((item, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="to-gray-900 text-lg font-medium">{item.name}</p>
